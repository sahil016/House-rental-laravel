	...
	<div class="prod-info-main prod-wrap clearfix">
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					...
					<img src="/img/8.jpg" alt="194x228" class="img-responsive"> 
				...
				<div class="product-info smart-form">
					<div class="row">
						<div class="col-md-12"> 
                            ...
                            <a href="/detail9" class=btn btn-danger">House Detail</a>
...
<div class="col-xs-12 col-md-6">
	...
	<div class="prod-info-main prod-wrap clearfix">
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="product-image"> 
						<img src="/img/6.jpg" alt="194x228" class="img-responsive">  
					</div>
				</div>
				<div class="col-md-7 col-sm-12 col-xs-12">
				<div class="product-deatil">
				...
				<div class="product-info smart-form">
					<div class="row">
						<div class="col-md-12"> 
							<a href="/book" class="btn btn-danger">Book</a>
                            <a href="/detail10" class=btn btn-danger">House Detail</a>
                            <a href="/rules" class=btn btn-danger"> Rules</a>
...
<!-- First product box start here-->
	<div class="prod-info-main prod-wrap clearfix">
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="product-image"> 
						<img src="/img/7.jpg" alt="194x228" class="img-responsive"> 
				...
				<div class="product-info smart-form">
					<div class="row">
						<div class="col-md-12"> 
							<a href="/book" class="btn btn-danger">Book</a>
                            <a href="/detail11" class=btn btn-danger">House Detail</a>
                            <a href="/rules" class=btn btn-danger"> Rules</a>
				...
				<div class="product-info smart-form">
					<div class="row">
						<div class="col-md-12"> 
                            ...
                            <a href="/detail12" class=btn btn-danger">House Detail</a>
                            <a href="/rules" class=btn btn-danger"> Rules</a>
