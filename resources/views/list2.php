	...
	<div class="prod-info-main prod-wrap clearfix">
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					...
					<img src="house2.jpg" alt="194x228" class="img-responsive"> 
				...
				<div class="product-info smart-form">
					<div class="row">
						<div class="col-md-12"> 
							<a href="javascript:void(0);" class="btn btn-danger">Book</a>
						</div>
						<div class="col-md-12">
...
<!-- First product box start here-->
	<div class="prod-info-main prod-wrap clearfix">
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="product-image"> 
						<img src="house3.jpg" alt="194x228" class="img-responsive"> 
...
<div class="col-xs-12 col-md-6">
	...
	<div class="prod-info-main prod-wrap clearfix">
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="product-image"> 
						<img src="house4.jpg" alt="194x228" class="img-responsive"> 
				...
				<div class="product-info smart-form">
					<div class="row">
						<div class="col-md-12"> 
							<a href="javascript:void(0);" href="ragister.php" class="btn btn-danger">Book</a>
...
<div class="col-xs-12 col-md-6">
	...
	<div class="prod-info-main prod-wrap clearfix">
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="product-image"> 
						<img src="house5.jpg" alt="194x228" class="img-responsive"> 
						<span class="tag2 sale">
							SALE
						</span> 
					</div>
				...
				<div class="product-deatil">
						<h5 class="name">
							<a href="#">
								House5 <span>House Category</span>
							</a>
						</h5>
						<p class="price-container">
							<span>17000 Rs</span>
...
<div class="col-xs-12 col-md-6">
	...
	<div class="prod-info-main prod-wrap clearfix">
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="product-image"> 
						<img src="house6.jpg" alt="194x228" class="img-responsive"> 
						<span class="tag2 sale">
							SALE
						</span> 
					</div>
				...
				<div class="product-deatil">
						<h5 class="name">
							<a href="#">
								House6 <span>House Category</span>
							</a>
						</h5>
						<p class="price-container">
							<span>15000</span>
